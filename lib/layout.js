...
const EXCHANGES = [
  ...
  { name: 'Binance', types: ['Spot', 'Futures', 'TradeFi'], colors: ['#946200', '#FFF6D9'] },
  { name: 'Bybit', types: ['Spot', 'Futures', 'TradeFi'], colors: ['#B35900', '#FFEEDD'] },
  { name: 'OKX', types: ['Spot', 'Futures', 'TradeFi'], colors: ['#0B5CFF', '#E8F0FE'] },
